...
int main(int argc, char* argv[]){
    ...
    for(int iter=0;iter<1;iter++)
    {
        ...
        cudaDeviceSynchronize();
        used_time = time_check_end();
        printf("2 :dropout time(include gen mask): %f ms\n", used_time);
#endif
        ...
        cudaDeviceSynchronize();
        used_time = time_check_end();
        printf("3 :tensor+matrix time: %f ms\n", used_time);
#endif
        ...
        cudaDeviceSynchronize();
        used_time = time_check_end();
        printf("4 :m&a gen mask time: %f ms\n", used_time);
#endif
        ...
        cudaDeviceSynchronize();
        used_time = time_check_end();
        printf("125 :logits dense mul time: %f ms\n", used_time); 
#endif        
        ...
        cudaDeviceSynchronize();
        used_time = time_check_end();
        printf("126 :calculate loss time: %f ms\n", used_time); 
#endif
        ...
        cudaDeviceSynchronize();
        used_time = time_check_end();
        printf("127 :cross entropy grad time: %f ms\n", used_time);
#endif
        ...
        cudaDeviceSynchronize();
        used_time = time_check_end();
        printf("128 :logits grad(dx&dw) time: %f ms\n", used_time); 
#endif
        ...
        for(int i = num_layers-1; i>=0; i--){
            ...
            cudaDeviceSynchronize();
            used_time = time_check_end();
            printf("%d :tensor+tensor time in %d layer: %f ms\n", 137+((num_layers-1)-i)*25, i+1, used_time);
#endif
            ...
            time_check_begin();
#endif
            layernorm_dg_db_gpu<<<seq_len, n>>>(d_norm_adg+(i*n), d_norm_adb+(i*n), dx1, embed_add+(i*m*n), norm_a_mean+(i*m), norm_a_rstd+(i*n), batch_size, seq_len, state);
            ...
            time_check_begin();
#endif     
            layernorm_grad_dx_gpu<<<m, n>>>(dx2, embed_add+(i*m*n), norm_a_mean+(i*m), norm_a_rstd+(i*m), dx1, d_norm_ag+(i*n), batch_size, seq_len, state);
        ...
        cudaDeviceSynchronize();
        used_time = time_check_end();
        printf("304 :x dropout grad time: %f ms\n", used_time);
#endif
        ...
        cudaDeviceSynchronize();
        used_time = time_check_end();
        printf("305 :p dropout grad time: %f ms\n", used_time);
#endif
        ...
        cudaDeviceSynchronize();
        used_time = time_check_end();
        printf("306 :embedding grad time: %f ms\n", used_time);
#endif
        ...
        cudaDeviceSynchronize();
        used_time = time_check_end();
        printf("307 :logits dw trans time: %f ms\n", used_time);
#endif
        ...
        cudaDeviceSynchronize();
        used_time = time_check_end();
        printf("308 :tensor+tensor time: %f ms\n", used_time);
#endif
        ...
        cudaDeviceSynchronize();
        used_time = time_check_end();
        printf("309 :Adam update time: %f ms\n", used_time);
#endif
